...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  ...
  $insertGoTo = "manage_chapters.php";
  if (isset($_SERVER['QUERY_STRING'])) {
...
$colchapid_rsViewChapters = "-1";
if (isset($_GET['chapter_id'])) {
  $colchapid_rsViewChapters = (get_magic_quotes_gpc()) ? $_GET['chapter_id'] : addslashes($_GET['chapter_id']);
}
...
mysql_select_db($database_conn, $conn);
$query_rsChapter = sprintf("SELECT * FROM course_chapters WHERE chapter_id = %s", $colname_rsChapter);
...
<!-- InstanceBeginEditable name="EditRegion3" -->
  <div class="row">
	...
	<div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
		<h1><?php echo $row_rsChapter['chapter_name']; ?></h1>
		<small>Course &quot;<strong><?php echo $row_rsView['course_name']; ?></strong>&quot; and Subject &quot;<strong><?php echo $row_rsSubject['subject_name']; ?></strong>&quot;</small>
		<hr />
	  <p class="page-header"><a href="index.php">Back to Courses</a> | <a href="manage_course.php?course_id=<?php echo $_GET['course_id']; ?>">Back to Subjects</a>  | <a href="manage_subjects.php?course_id=<?php echo $_GET['course_id']; ?>&subject_id=<?php echo $_GET['subject_id']; ?>">Back to Chapters </a> </p>
	  <h3>Create Topics </h3>
...
<?php } ?>
  ...
  <table class="table">
            <tr valign="baseline">
                <td nowrap align="right">Topic Name:</td>
                <td><input name="topic_name" type="text" id="topic_name" value="" size="32"></td>
            </tr>
            <tr valign="baseline">
                <td nowrap align="right" valign="top">Topic Description:</td>
                <td><textarea name="topic_description" cols="50" rows="5" id="topic_description"></textarea>                </td>
            </tr>
            <tr valign="baseline">
...
<div class="table-responsive">
  <table class="table">
        ...
        <?php do { ?>
            <tr>
                <td><?php echo $row_rsViewChapters['topic_name']; ?></td>
                <td><?php echo $row_rsViewChapters['topic_description']; ?></td>
                <td><?php echo $row_rsViewChapters['topic_creation_dt']; ?></td>
                <td><?php echo $row_rsViewChapters['topic_enabled']; ?></td>
                <td><?php echo $row_rsViewChapters['topic_sorting']; ?></td>
                <td><a href="manage_topics.php?course_id=<?php echo $row_rsViewChapters['course_id']; ?>&subject_id=<?php echo $row_rsViewChapters['subject_id']; ?>&chapter_id=<?php echo $row_rsViewChapters['chapter_id']; ?>&topic_id=<?php echo $row_rsViewChapters['topic_id']; ?>">Manage</a></td>
                <td>Edit</td>
                <td>Delete</td>
            </tr>
