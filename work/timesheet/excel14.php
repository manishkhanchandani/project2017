...
<?php
session_start();
//$include_path=".;c:\wamp\www\mk2\includes\pear";
...
function getCategory($u, $fromdate, $todate) {
	...
	$query = "select DISTINCT pt.category, pl.list from mk_timesheet as pt, mk_list as pl where pt.user_id like '".$u."' and pt.cdate between '".$fromdate."' and '".$todate."' and pt.category = pl.list_id and pl.list_id = '".$_GET['list_id']."'";
