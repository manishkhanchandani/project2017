...
<p><a href="usertimesheet.php?e=<?php echo $_SESSION['MM_Username']; ?>&mydate=<?php if($_GET['mydate']) echo $_GET['mydate']; else echo date('Y-m-d'); ?>" target="_blank">External Link</a></p>
<p>&nbsp; </p>
<!-- InstanceEndEditable -->
</td>
      </tr>
