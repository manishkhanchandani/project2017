...
if (isset($_POST['username'])) {
  ...
  $LoginRS__query=sprintf("SELECT username, password, accesslevel FROM mk_users WHERE username='%s' AND password='%s'",
...
<h3>Login</h3>
<p class="style1">Username and Password Does Not Match. Please Try Again</p>
