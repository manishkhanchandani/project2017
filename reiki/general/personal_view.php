...
$query_rsView = sprintf("SELECT * FROM reiki_students_record WHERE user_id = %s ORDER BY personal_id DESC", $colname_rsView);
  			...
  			<table class="table">
                  <tr>
                      <td valign="top"><strong>Name</strong></td>
                          ...
                          <td valign="top"><strong>Training Level </strong></td>
                          <td valign="top"><strong>Training Date </strong></td>
                          <td valign="top"><strong>Year of Birth </strong></td>
                          <td valign="top"><strong>Gender</strong></td>
                          <td valign="top"><strong>Previous Reiki Experience </strong></td>
                          <td valign="top"><strong>Why you want to learn reiki </strong></td>
                          <td valign="top"><strong>What you know about Reiki </strong></td>
                        </tr>
                  <?php do { ?>
                          <tr>
                              <td valign="top"><?php echo $row_rsView['name']; ?></td>
                                ...
                                <td valign="top"><?php echo $row_rsView['level']; ?></td>
                                <td valign="top"><?php echo $row_rsView['class_date']; ?></td>
                                <td valign="top"><?php echo $row_rsView['yearofbirth']; ?></td>
                              <td valign="top"><?php echo $row_rsView['gender']; ?></td>
                              <td valign="top"><?php echo $row_rsView['previous_reiki']; ?></td>
                              <td valign="top"><?php echo $row_rsView['why_reiki']; ?></td>
                              <td valign="top"><?php echo $row_rsView['knowledge_reiki']; ?></td>
                            </tr>
