...
<title>Rei-ki : Daily Practice</title>
<!-- InstanceEndEditable -->
...
<!-- InstanceBeginEditable name="EditRegion3" -->
  <h1 class="page-header">Daily Practice</h1>

  <div id="content" class="visual">
      <p><strong>Chant Following Every day</strong></p>
      ...
      <hr>
      <p>Pracice Reiki on all chakras, try to overpower all the points of each chakras. </p>
      <p>From today, I will devote my life to Reiki, I will try to avoid all the medications.</p>
      <p>&nbsp;</p>
      <p>&nbsp;</p>
      <p>&nbsp; </p>
  </div>
