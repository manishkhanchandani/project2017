...
try {
    ...
    $query_rsSubjects = "SELECT * FROM baby_bar_subjects WHERE is_visible = 1 and subject_id = ".GetSQLValueString($_GET['id'], 'int')." ORDER BY subject_id ASC";
