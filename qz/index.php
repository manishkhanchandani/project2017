...
mysql_select_db($database_conn, $conn);
$query_rsCategory = sprintf("SELECT * FROM qz_categories WHERE parent_id = %s", $colname_rsCategory);
...
<form method="post" name="form1" action="<?php echo $editFormAction; ?>">
  <table>
    ...
    <tr valign="baseline">
      ...
      <td><input type="text" name="parent_id" value="<?php echo $_GET['parent_id']; ?>" size="32"></td>
    </tr>
    <tr valign="baseline">
...
<?php if ($totalRows_rsCategory > 0) { // Show if recordset not empty ?>
  ...
  <table border="1">
    ...
    <?php do { ?>
      <tr>
        ...
        <td><a href="category.php?parent_id=<?php echo $row_rsCategory['cat_id']; ?>">Add Child</a> </td>
  ...
  <p>&nbsp;
    Records <?php echo ($startRow_rsCategory + 1) ?> to <?php echo min($startRow_rsCategory + $maxRows_rsCategory, $totalRows_rsCategory) ?> of <?php echo $totalRows_rsCategory ?></p>
